...
class Country(models.Model):
	country = models.CharField('Старана', max_length = 64, default='')
...
class Currency(models.Model):
	currency = models.CharField('Валюта', max_length = 64, default='')
...
class Category(models.Model):
	category = models.CharField('Категория', max_length = 64,db_index =True, default='')
